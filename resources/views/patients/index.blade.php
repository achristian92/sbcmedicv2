...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-9 col-md-6">
            <h5 class="mb-0">Pacientes ({{ $patients->total() }})</h5>
        </div>
        <div class="col text-end">
            <a href="{{ route('patients.create') }}" class="btn btn-sm btn-primary">Nuevo</a>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <select class="form-select form-control" name="sex">
                        ...
                        <option value="M" {{ old('sex', request('sex')) === 'M' ? 'selected' : '' }}>Masculino</option>
                        <option value="F" {{ old('sex', request('sex')) === 'F' ? 'selected' : '' }}>Femenino</option>
                    </select>
                </div>
                <div class="col-auto">
                        ...
                        @foreach($patients as $key => $use)
                            <tr>
                                ...
                                <td class="text-end p-3">
                                    ...
                                    <a href="{{ route('patients.edit',$use->id) }}" class="btn btn-icon btn-pills btn-soft-success"><i class="uil uil-pen"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
